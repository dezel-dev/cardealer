...
CREATE TABLE `cardealer_stock` (
                                   ...
                                   `inDeliver` tinyint(1) NOT NULL,
                                   `deliverTime` int(11) NOT NULL,
                                   `isStored` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

ALTER TABLE `cardealer_stock`
    ADD UNIQUE KEY `plate` (`plate`);
COMMIT;

CREATE TABLE `cardealer_history_buy` (
                                         `id` int(11) NOT NULL,
...
ALTER TABLE `cardealer_history_buy`
    ADD PRIMARY KEY (`id`);